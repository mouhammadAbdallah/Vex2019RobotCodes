...
task autonomous()
{
	...
	clearTimer(T3);
	while(((SensorValue[leftTouch]!=1) ||( SensorValue[rightTouch]!=1))&&(time1(T3)<5000)){
		moveRobot(-70 ,-70);
	}
	moveRobot(0,0);
	delay(50);
	...
	while(((SensorValue[lFLeft]<2000) &&( SensorValue[lFRight]<2000))){
		moveRobot(40,40);
	}
	moveRobot(0,0);
	delay(50);
